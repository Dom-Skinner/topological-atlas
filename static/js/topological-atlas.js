...
async function initData() {
    try {
        ...
        globalDbMulti = await fetchCSV('topological-altas/static/data/db_multi.csv');
        console.log("db_multi loaded_:", globalDbMulti);
        console.log("Last 3 items of db_multi:", globalDbMulti.slice(-3));
        const d_mat = await fetchCSV('topological-altas/static/data/total_distance_compute.csv');
